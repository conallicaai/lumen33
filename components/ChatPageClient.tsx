  ...
  useEffect(() => {
    ...
    if (showIntro) {
      timeoutId = setTimeout(() => {
        setShowIntro(false);
      }, 20000); // Intro closes after 20 seconds
    }
      ...
      <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-[#05090e] text-[#e0f2f1]">
        <div className="absolute inset-0 z-0 overflow-hidden opacity-80 pointer-events-none">
           <iframe
             ...
             src="https://www.canva.com/design/DAGdmw5y4YI/3o59_fU7U9E82iVhyB4_AQ/watch?embed"
        ...
        <div className="z-10 relative flex flex-col items-center mt-[10vh]">
